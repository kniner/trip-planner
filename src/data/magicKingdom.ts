...
export const MAGIC_KINGDOM: Attraction[] = [
  ...
  // Daytime & nighttime entertainment — offered on regular (non-party) days.
  // avgWait/maxWait model how early to stake out a good viewing spot.
  {
    ...
    duration: 12,
    coords: { x: 250, y: 250 },
    liveName: 'Disney Festival of Fantasy Parade',
    note: 'The daily 3:00 PM parade • route runs Frontierland → Liberty Square → Main Street',
  },
  {
    ...
    duration: 18,
    coords: { x: 300, y: 300 },
    liveName: 'Happily Ever After',
    note: 'Nighttime fireworks & projections on Cinderella Castle',
  },
  {
    id: 'friendship-faire',
    ...
    duration: 20,
    coords: { x: 300, y: 285 },
    liveName: "Mickey's Magical Friendship Faire",
    note: 'Castle forecourt stage show • runs several times daily',
  },
  {
    id: 'adventure-friends-cavalcade',
